    ...
    def run_Lan(self):
        ...
        while not self.__queue_lan.full():
            ...
            if not self.__config_setup_lan.get_setup_OK():
                ...
                if r_plen_CeRouter == int(self.__config.get('t2.7.3a','pd_prefixlen')):
                    logging.info('Aprovado Teste 2.7.3a r_plen_CeRouter é igual pd_prefixlen')
                    #self.__packet_sniffer_lan.stop()
                    #return True
                else:                     
                ...
                if r_rtlifetime_CeRouter < int(self.__config.get('t2.7.3a','routerlifetime')):
                    logging.info(' Teste 2.7.3a: r_rtlifetime_CeRouter OK. r_rtlifetime dentro do especificado no RA')
                    #self.__packet_sniffer_lan.stop()
                    #return True
                else:                     
                    logging.info(' Teste2.7.3a: Reprovado. preferredlifetime acima do especificado no RA')
